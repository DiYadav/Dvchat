...
from .models import Profile, Post, LikePost, Follower, Conversation, Message ,Notification , Comment,User 
...
def message_inbox(request):
    ...
    context = {
        'conversations_data': conversations_with_others, 
...
# core/views.py (within your start_conversation view)
...
def start_conversation(request, user_id):
    ...
    # This might be too frequent for every conversation start.
    # You might prefer to create notifications only when a new message is sent.
    Notification.objects.create(
        recipient=recipient,
        sender=request.user,
        notification_type='message',
        message=f"{request.user.username} started a conversation with you."
        # You could also link to the conversation here
    )
    # ---------------------------------------------
